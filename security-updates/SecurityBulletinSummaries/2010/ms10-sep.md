...
<td style="border:1px solid black;"><strong>Sårbarhed i tjenesten Print Spooler kan tillade fjernudførelse af kode (2347290)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>En sårbarhed i MPEG-4 Codec kan muliggøre fjernudførelse af kode (975558)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>En sårbarhed i Unicode Scripts Processor (USP) kan tillade fjernudførelse af kode (2320113)</strong><br />
<br />
...
<td style="border:1px solid black;"><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0820">CVE-2010-0820</a></td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/en-us/security/cc998259.aspx"><strong>1</strong></a> - Konsekvent exploit-kode sandsynlig</td>
...
<td style="border:1px solid black;"><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2731">CVE-2010-2731</a></td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/en-us/security/cc998259.aspx"><strong>1</strong></a> - Konsekvent exploit-kode sandsynlig</td>
  ...
  <tr class="thead">
    ...
    <th style="border:1px solid black;"></th>
                ...
                <tr><td style="border:1px solid black;">Windows Server 2003 med SP2 til Itanium-baserede systemer</td><td style="border:1px solid black;">
                    ...
                    <br />(KB981322)<br />(Kritisk)</td><td style="border:1px solid black;">IIS-ASP:<br /><a runat="server" href="http://www.microsoft.com/downloads/details.aspx?familyid=f6841057-1745-44e9-a16a-c180dd941ddf">Internet Information Services 6.0</a><br />(KB2124261)<br />(Alvorlig)</td><td style="border:1px solid black;">
  ...
  <tr class="thead">
    ...
    <th style="border:1px solid black;"></th>
                ...
                <tr><td style="border:1px solid black;">Microsoft Office XP Service Pack 3</td><td style="border:1px solid black;">
                    ...
                    <br />(KB2288608)<br />(Alvorlig)</td><td style="border:1px solid black;">
                ...
                <tr class="alternateRow"><td style="border:1px solid black;">Microsoft Office 2003 Service Pack 3</td><td style="border:1px solid black;">
                    ...
                    <br />(KB2288613)<br />(Alvorlig)</td><td style="border:1px solid black;">
                ...
                <tr><td style="border:1px solid black;">Microsoft Office 2007 Service Pack 2</td><td style="border:1px solid black;">
                    ...
                    <br />(KB2288621)<br />(Alvorlig)</td><td style="border:1px solid black;">
