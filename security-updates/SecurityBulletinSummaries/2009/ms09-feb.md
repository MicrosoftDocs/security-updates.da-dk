...
<td style="border:1px solid black;"><strong>Samlet sikkerhedsopdatering til Internet Explorer (961260)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Sårbarheder i Microsoft Exchange kan give mulighed for fjernudførelse af kode (959239)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Sårbarhed i Microsoft SQL Server kan muliggøre fjernudførelse af kode (959420)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Sårbarheder i Microsoft Office Visio kan muliggøre fjernudførelse af kode (957634)</strong><br />
<br />
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=139814">MS09-002</a></td>
<td style="border:1px solid black;">Samlet sikkerhedsopdatering til Internet Explorer (961260)</td>
...
<td style="border:1px solid black;">En konsekvent exploit-kode kan nemt udformes.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=139814">MS09-002</a></td>
<td style="border:1px solid black;">Samlet sikkerhedsopdatering til Internet Explorer (961260)</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=136636">MS09-003</a></td>
<td style="border:1px solid black;">Sårbarheder i Microsoft Exchange kan muliggøre fjernudførelse af kode (959239)</td>
...
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/en-us/security/cc998259.aspx"><strong>2</strong></a> - Inkonsekvent exploit-kode sandsynlig</td>
<td style="border:1px solid black;">Dette er en Denial of Service-sårbarhed. Angreb, der udnytter denne sårbarhed, vil sandsynligvis kun medføre Denial-Of-Service, ikke fjernudførelse af kode. </td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=139513">MS09-004</a></td>
<td style="border:1px solid black;">Sårbarhed i Microsoft SQL Server kan muliggøre fjernudførelse af kode (959420)</td>
<td style="border:1px solid black;"><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-5416">CVE-2008-5416</a></td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/en-us/security/cc998259.aspx"><strong>1</strong></a> - Konsekvent exploit-kode sandsynlig</td>
<td style="border:1px solid black;">Efter godkendelse er en funktionel exploit-kode blevet udgivet.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=128107">MS09-005</a></td>
<td style="border:1px solid black;">Sårbarheder i Microsoft Office Visio kan muliggøre fjernudførelse af kode (957634)</td>
...
<table xmlns="http://www.w3.org/1999/xhtml">
  <tr class="thead">
    ...
    <th style="border:1px solid black;"></th>
                ...
                <tr><td style="border:1px solid black;">Windows Server 2003 med SP1 til Itanium-baserede systemer og Windows Server 2003 med SP2 til Itanium-baserede systemer</td><td style="border:1px solid black;">
                ...
                <tr class="alternateRow"><td style="border:1px solid black;">Windows Server 2008 til 32 bit-systemer                    </td><td style="border:1px solid black;">
                ...
                <tr class="alternateRow"><td style="border:1px solid black;">Windows Server 2008 til Itanium-baserede systemer</td><td style="border:1px solid black;">
...
<table xmlns="http://www.w3.org/1999/xhtml">
  <tr class="thead">
    ...
    <th style="border:1px solid black;"></th>
                ...
                <tr><th colspan="2" style="border:1px solid black;">Microsoft Office Visio</th></tr>
